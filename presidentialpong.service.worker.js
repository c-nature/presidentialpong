...
/** @type {string} */
const CACHE_VERSION = '1753320872|92207197930';
/** @type {string} */
const CACHE_PREFIX = 'ponggame-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'presidentialpong.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["presidentialpong.html","presidentialpong.js","presidentialpong.offline.html","presidentialpong.icon.png","presidentialpong.apple-touch-icon.png","presidentialpong.audio.worklet.js","presidentialpong.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["presidentialpong.wasm","presidentialpong.pck"];
